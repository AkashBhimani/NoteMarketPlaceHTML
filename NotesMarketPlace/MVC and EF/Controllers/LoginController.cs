...
namespace NotesMarketPlace.Controllers
{
    public class LoginController : Controller
    {
        ...
        [HttpPost]
        public ActionResult VerifyEmailAddress(string emailID)
        {
            var db_user = context.Users.Where(m => m.EmailID == emailID).FirstOrDefault();
            if(db_user != null)
            {
                SendRandomPasswordEmail(emailID);
